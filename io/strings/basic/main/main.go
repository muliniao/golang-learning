...
func main() {
	...
	fmt.Printf("The second output len(%d), cap(%d):\n\"%s\"\n", builder1.Len(), builder1.Cap(), builder1.String())
	fmt.Println()

	// 示例2。
	fmt.Println("Grow the builder ...")
	builder1.Grow(10)
	fmt.Printf("The length of contents in the builder is len(%d), cap(%d).\n", builder1.Len(), builder1.Cap())
	fmt.Println()

	// 示例3。
	fmt.Println("Reset the builder ...")
	builder1.Reset()
	fmt.Printf("The third output len(%d), cap(%d):\n%q\n", builder1.Len(), builder1.Cap(), builder1.String())
	fmt.Println()
}
